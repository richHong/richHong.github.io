...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;In this section, we will be using the Terminal application and the command line interface to install the applications we need. Open up Terminal by pressing, ⌘ space, and typing 'terminal' in Spotlight.
